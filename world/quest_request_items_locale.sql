...
-- Exportiere Struktur von Tabelle 3.3.5_world.quest_request_items_locale
...
-- Exportiere Daten aus Tabelle 3.3.5_world.quest_request_items_locale: ~859 rows (ungefähr)
