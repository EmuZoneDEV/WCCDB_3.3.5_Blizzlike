...
-- Exportiere Struktur von Tabelle 3.3.5_auth.updates
...
-- Exportiere Daten aus Tabelle 3.3.5_auth.updates: 52 rows
...
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_05_15_00_auth.sql', '8A7B96E66D689DA63380654142FF60A1EE938697', 'ARCHIVED', '2019-05-15 08:13:20', 5);
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_06_06_00_auth.sql', '6DE8159E04BEE7BA0A4A81D72D160EB74934B6A5', 'ARCHIVED', '2019-07-20 03:56:42', 310);
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_06_15_00_auth.sql', '456B92D99FFD2E7B6CBF64F4C68555A42B24B298', 'ARCHIVED', '2019-07-20 03:56:42', 14);
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_06_16_00_auth.sql', 'B14AED4D3387B56FF8C8161D3671750AEEAE0F2E', 'ARCHIVED', '2019-07-20 03:56:42', 19);
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_06_21_00_auth.sql', 'C519239830204B68E710F698BC0C9E89B6D5FD24', 'ARCHIVED', '2019-07-20 03:56:42', 18);
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_07_15_00_auth.sql', '64B491CD197A4466D7F739D67DD30C9502FF393A', 'RELEASED', '2019-07-20 03:56:42', 13);
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_07_16_00_auth.sql', '36CB53A9EBD64BFDCF7030083E36E534F1753773', 'RELEASED', '2019-07-20 03:56:42', 16);
REPLACE INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_07_17_00_auth.sql', '4F983F039904894ACC483BE885676C5F0A18F06B', 'RELEASED', '2019-07-20 03:56:42', 18);
