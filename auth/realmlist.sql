...
-- Exportiere Struktur von Tabelle 3.3.5_auth.realmlist
...
-- Exportiere Daten aus Tabelle 3.3.5_auth.realmlist: ~0 rows (ungefähr)
...
REPLACE INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`) VALUES
	(1, 'Trinity', '127.0.0.1', '127.0.0.1', '255.255.255.0', 8085, 1, 2, 9, 0, 0, 12340);
