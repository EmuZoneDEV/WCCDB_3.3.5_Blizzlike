...
-- Exportiere Struktur von Tabelle 3.3.5_chars.character_queststatus_seasonal
...
-- Exportiere Daten aus Tabelle 3.3.5_chars.character_queststatus_seasonal: ~0 rows (ungefähr)
