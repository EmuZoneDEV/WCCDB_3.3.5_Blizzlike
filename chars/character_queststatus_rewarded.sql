...
-- Exportiere Struktur von Tabelle 3.3.5_chars.character_queststatus_rewarded
...
-- Exportiere Daten aus Tabelle 3.3.5_chars.character_queststatus_rewarded: ~0 rows (ungefähr)
