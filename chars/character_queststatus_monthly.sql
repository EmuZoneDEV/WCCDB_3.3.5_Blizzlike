...
-- Exportiere Struktur von Tabelle 3.3.5_chars.character_queststatus_monthly
...
-- Exportiere Daten aus Tabelle 3.3.5_chars.character_queststatus_monthly: ~0 rows (ungefähr)
