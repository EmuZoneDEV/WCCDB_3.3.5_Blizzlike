...
-- Exportiere Struktur von Tabelle 3.3.5_chars.custom_transmogrification
...
-- Exportiere Daten aus Tabelle 3.3.5_chars.custom_transmogrification: ~0 rows (ungefähr)
