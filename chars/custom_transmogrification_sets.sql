...
-- Exportiere Struktur von Tabelle 3.3.5_chars.custom_transmogrification_sets
...
-- Exportiere Daten aus Tabelle 3.3.5_chars.custom_transmogrification_sets: ~0 rows (ungefähr)
