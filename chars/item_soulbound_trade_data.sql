...
-- Exportiere Struktur von Tabelle 3.3.5_chars.item_soulbound_trade_data
...
-- Exportiere Daten aus Tabelle 3.3.5_chars.item_soulbound_trade_data: ~0 rows (ungefähr)
